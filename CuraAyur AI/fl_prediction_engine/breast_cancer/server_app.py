"""
server_app.py — Flower ServerApp for Breast Cancer FL.
...
def main(grid: Grid, context: Context) -> None:
    ...
    joblib.dump(model, output_path / "breast_fl_model.joblib")
    joblib.dump(get_scaler(), output_path / "breast_scaler.joblib")

    print(f"\n[SAVED] Model -> {output_path / 'breast_fl_model.joblib'}")
    print(f"[SAVED] Scaler -> {output_path / 'breast_scaler.joblib'}")
