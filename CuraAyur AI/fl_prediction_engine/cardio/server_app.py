"""
server_app.py — Flower ServerApp for Cardiovascular FL.
...
def main(grid: Grid, context: Context) -> None:
    ...
    joblib.dump(model, output_path / "cardio_fl_model.joblib")
    joblib.dump(get_scaler(), output_path / "cardio_scaler.joblib")

    print(f"\n[SAVED] Model -> {output_path / 'cardio_fl_model.joblib'}")
    print(f"[SAVED] Scaler -> {output_path / 'cardio_scaler.joblib'}")
